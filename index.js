const cities = [
  ...
  **********/
  ...
  function getCityPopulation(city) {
    // Your code here
    const getPopulation = city.population
  ...
  **********/
  ...
  function isPopulationAboveThreshold(city, threshold) {
    // Your code here
    const cityThreshold = !!(city.population >= threshold)
  ...
  **********/
  ...
  function countCitiesInCountry(cities, country) {
    // Your code here
    const getCityName = cities.reduce( (total,city)=> city.country == country?total+=1:total,0)
    return getCityName
